...
ON_vaccine_data = vaccine_Data.loc[vaccine_Data['province'] == "BC"]
...
plt.title("BC Daily Vaccine Administration Data", fontsize=22, color="white")
...
plt.legend()
plt.savefig('BC_Vaccine_Graph by Day.png')
...
plt.rc('font', size=14)
plt.locator_params(axis='x', nbins=16)
plt.title("BC Cumulative Vaccine Administration Data", fontsize=22, color="white")
plt.xlabel('Date', fontsize=18, color="white")
plt.ylabel('Shots Administered', fontsize=20, color="white")
...
ax.yaxis.offsetText.set_fontsize(16)
plt.legend()
plt.savefig('BC_Vaccine_Graph Cumulative.png')